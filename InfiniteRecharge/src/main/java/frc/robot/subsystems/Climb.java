...
public class Climb extends Subsystem {
    ...
    private CANEncoder climbLiftEncoder;
    ...
    private WPI_TalonSRX climbWingeMotor;
    private Compressor compressor;
    private DoubleSolenoid lockSolenoid;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    CANSparkMax climbLiftMotor;
    // CANSparkMax climbWinchMotor;

    public Climb() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        climbWingeMotor = new WPI_TalonSRX(2);
        ...
        lockSolenoid = new DoubleSolenoid(0, 0, 1);
        addChild("LockSolenoid",lockSolenoid);

        
    
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        climbLiftMotor = new CANSparkMax(17, MotorType.kBrushless);
    ...
    public void setClimbWingeMotor(double power) {
        climbWingeMotor.set(power);
    }

    public double getClimbLiftEncoder() {
        return climbLiftEncoder.getPosition();
    }
