...
public class OI {
    ...
    public OI() {
        ...
        climbingCloseLockButton.whenPressed(new ClimbingCloseLockCommand());
        climbingOpenLockButton = new JoystickButton(operatorController, 1);
        climbingOpenLockButton.whenPressed(new ClimbingOpenLockCommand());
        ...
        acquisitionConveyerButton.whileHeld(new AcquisitionConveyerCommand());
        ...
        SmartDashboard.putData("ClimbingOpenLockCommand", new ClimbingOpenLockCommand());
        SmartDashboard.putData("ClimbingCloseLockCommand", new ClimbingCloseLockCommand());
        SmartDashboard.putData("AcquisitionConveyerCommand", new AcquisitionConveyerCommand());
