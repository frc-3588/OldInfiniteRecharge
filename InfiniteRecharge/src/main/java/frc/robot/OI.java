...
public JoystickButton manualClimbButton;
...
manualClimbButton = new JoystickButton(driverController, 3);
manualClimbButton.whileHeld(new ManualClimbCommand());
highClimbingButton = new JoystickButton(driverController, 2);
...
lowClimbingButton.whenPressed(new LowClimbCommand());
        ...
        SmartDashboard.putData("ManualClimbOffCommand", new ManualClimbOffCommand());
